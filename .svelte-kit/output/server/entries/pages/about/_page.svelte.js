...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-l32z5m_START -->${$$result.title = `<title>About</title>`, ""}<meta name="description" content="About Ryan Hill"><!-- HEAD_svelte-l32z5m_END -->`, ""} <div class="text-column" data-svelte-h="svelte-h1zwnb"><h1>About this app</h1> <p>This is a <a href="https://kit.svelte.dev">SvelteKit</a> app. You can make your own by typing the
